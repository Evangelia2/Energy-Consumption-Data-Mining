...
After downloading, place the dataset file inside the project folder before running the notebooks.
...
- Understand large-scale time-series data  
- Prepare raw data for analysis through preprocessing  
